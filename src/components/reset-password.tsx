    ...
    return (
      <Card className="w-full max-w-md text-center">
        <CardHeader>
          ...
          <CardDescription>This link is either expired or invalid. Please request a new one.</CardDescription>
        </CardHeader>
        <CardContent>
    ...
    return (
      <Card className="w-full max-w-md text-center">
        <CardHeader>
          ...
          <CardDescription>Your password has been updated successfully. You can now log in with your new password.</CardDescription>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="space-y-1">
        ...
        <CardDescription>This will be the new password for your account.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={isLoading}>
              {isLoading ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" />Please wait...</> : 'Set New Password'}
            </Button>
          </form>
        </Form>
      </CardContent>
